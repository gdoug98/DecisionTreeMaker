    ...
    public class Hexagon : Shape
    {
        protected override Geometry DefiningGeometry
        {
            get
            {
                ...
                segments[3] = new LineSegment { Point = new Point(RenderTransformOrigin.X + (0.85f * Width), RenderTransformOrigin.Y + Height) };
                segments[4] = new LineSegment { Point = new Point(RenderTransformOrigin.X + (0.15f * Width), RenderTransformOrigin.Y + Height) };
                segments[5] = new LineSegment { Point = new Point(RenderTransformOrigin.X, RenderTransformOrigin.Y + (Height / 2)) };
